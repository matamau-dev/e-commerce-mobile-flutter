...
class ProductLineFormDialog extends StatefulWidget {
  final String title;
  final String? initialName;
  final bool isSubCategory;
  final List<String>? categories;
  const ProductLineFormDialog({
    super.key,
    required this.title,
    this.initialName,
  ...
  @override
  State<ProductLineFormDialog> createState() => _ProductLineFormDialogState();
}

class _ProductLineFormDialogState extends State<ProductLineFormDialog> {
